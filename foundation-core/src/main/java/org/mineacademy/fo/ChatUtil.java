...
public final class ChatUtil {
	 ...
	 */
	private final static int VISIBLE_CHAT_LINES = 20;
	...
	/**
	 * Centers a message automatically for padding ,see CENTER_PX
	 *
	 * @param message
	 * @return
	 */
	...
	/**
	 * Centers a message for padding CENTER_PX with the given space character
	...
	public static String[] verticalCenter(final Collection<String> messages) {
		...
		final long padding = MathUtilCore.ceiling((VISIBLE_CHAT_LINES - messages.size()) / 2);

		for (int i = 0; i < padding; i++)
			lines.add(RandomUtilCore.nextColorOrDecoration() + RandomUtilCore.nextColorOrDecoration() + RandomUtilCore.nextColorOrDecoration());
