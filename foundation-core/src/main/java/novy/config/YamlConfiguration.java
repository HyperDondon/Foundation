...
import org.mineacademy.fo.settings.PlatformNeutralYamlConstructor;
...
public class YamlConfiguration extends FileConfiguration {
	...
	public final <T> T getT(String path, Class<T> clazz, Object... deserializeParams) {
	...
	private MappingNode toNodeTreeWithDefaults(MemorySection section, MemorySection defaults) {
		...
		// You can configure which sections are allowed to stay using uncommentedSections field above.
		{
			...
			if (!unusedKeys.isEmpty()) {
				...
				final YamlConfiguration unusedConfig = YamlConfiguration.loadConfiguration(unusedFile);
	...
	public final void setUncommentedSections(Set<String> uncommentedSections) {
